      ...
      <div className="app-container-change-password">
        <div className="main-content-change-password">
          <div className="change-password-box">
            <Link to="/edit-user" className="back-arrow-change-password" aria-label="Volver a editar perfil">←</Link>
            ...
            <div className="additional-links">
              <label className="login-redirect">
                <Link to="/edit-user" className="login-link">Volver a editar perfil</Link>
              </label>
              <label className="login-redirect">
                <Link to="/user" className="login-link">Ir al perfil</Link>
              </label>
            </div>
          </div>
        </div>
